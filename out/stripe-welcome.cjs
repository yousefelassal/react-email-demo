...
var stripe_welcome_exports = {};
__export(stripe_welcome_exports, {
  StripeWelcomeEmail: () => StripeWelcomeEmail,
  default: () => stripe_welcome_default
});
module.exports = __toCommonJS(stripe_welcome_exports);
...
var Head = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("head", __spreadProps4(__spreadValues4({}, props), { children: [
...
var Html = (_a) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("html", __spreadProps6(__spreadValues6({}, props), { dir, lang, children }));
};
...
var StripeWelcomeEmail = () => /* @__PURE__ */ React.createElement(Html, null, /* @__PURE__ */ React.createElement(Head, null), /* @__PURE__ */ React.createElement(Preview, null, "You're now ready to make live transactions with Stripe!"), /* @__PURE__ */ React.createElement(Body, { style: main }, /* @__PURE__ */ React.createElement(Container, { style: container }, /* @__PURE__ */ React.createElement(Section, { style: box }, /* @__PURE__ */ React.createElement(
  Img,
  {
...
), /* @__PURE__ */ React.createElement(Hr, { style: hr }), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "Thanks for submitting your account information. You're now ready to make live transactions with Stripe!"), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "You can view your payments and a variety of other information about your account right from your dashboard."), /* @__PURE__ */ React.createElement(Button, { style: button, href: "https://dashboard.stripe.com/login" }, "View your Stripe Dashboard"), /* @__PURE__ */ React.createElement(Hr, { style: hr }), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "If you haven't finished your integration, you might find our", " ", /* @__PURE__ */ React.createElement(Link, { style: anchor, href: "https://stripe.com/docs" }, "docs"), " ", "handy."), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "Once you're ready to start accepting payments, you'll just need to use your live", " ", /* @__PURE__ */ React.createElement(
  Link,
  {
    style: anchor,
  ...
  "API keys"
), " ", "instead of your test API keys. Your account can simultaneously be used for both test and live requests, so you can continue testing while accepting live payments. Check out our", " ", /* @__PURE__ */ React.createElement(Link, { style: anchor, href: "https://stripe.com/docs/dashboard" }, "tutorial about account basics"), "."), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "Finally, we've put together a", " ", /* @__PURE__ */ React.createElement(
  Link,
  {
    style: anchor,
  ...
  "quick checklist"
), " ", "to ensure your website conforms to card network standards."), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "We'll be here to help you with any step along the way. You can find answers to most questions and get in touch with us on our", " ", /* @__PURE__ */ React.createElement(Link, { style: anchor, href: "https://support.stripe.com/" }, "support site"), "."), /* @__PURE__ */ React.createElement(Text, { style: paragraph }, "\u2014 The Stripe team"), /* @__PURE__ */ React.createElement(Hr, { style: hr }), /* @__PURE__ */ React.createElement(Text, { style: footer }, "Stripe, 354 Oyster Point Blvd, South San Francisco, CA 94080")))));
var stripe_welcome_default = StripeWelcomeEmail;
var main = {
