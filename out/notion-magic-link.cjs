...
var notion_magic_link_exports = {};
__export(notion_magic_link_exports, {
  NotionMagicLinkEmail: () => NotionMagicLinkEmail,
  default: () => notion_magic_link_default
});
module.exports = __toCommonJS(notion_magic_link_exports);
...
var renderWhiteSpace = (text2) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { children: whiteSpaceCodes.repeat(PREVIEW_MAX_LENGTH - text2.length) });
};
...
var NotionMagicLinkEmail = ({
  loginCode
}) => /* @__PURE__ */ React.createElement(Html, null, /* @__PURE__ */ React.createElement(Head, null), /* @__PURE__ */ React.createElement(Preview, null, "Log in with this magic link"), /* @__PURE__ */ React.createElement(Body, { style: main }, /* @__PURE__ */ React.createElement(Container, { style: container }, /* @__PURE__ */ React.createElement(Heading, { style: h1 }, "Login"), /* @__PURE__ */ React.createElement(
  Link,
  {
...
), /* @__PURE__ */ React.createElement(Text, { style: { ...text, marginBottom: "14px" } }, "Or, copy and paste this temporary login code:"), /* @__PURE__ */ React.createElement("code", { style: code }, loginCode), /* @__PURE__ */ React.createElement(
  Text,
  {
    style: {
      ...text,
...
), /* @__PURE__ */ React.createElement(Text, { style: footer }, /* @__PURE__ */ React.createElement(
  Link,
  {
    href: "https://notion.so",
    target: "_blank",
  ...
  "Notion.so"
), ", the all-in-one-workspace", /* @__PURE__ */ React.createElement("br", null), "for your notes, tasks, wikis, and databases."))));
NotionMagicLinkEmail.PreviewProps = {
  loginCode: "sparo-ndigo-amurt-secan"
};
var notion_magic_link_default = NotionMagicLinkEmail;
var main = {
